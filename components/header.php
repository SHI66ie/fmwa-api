                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="departmentsDropdown">
                            <li><a class="dropdown-item <?php echo ($current_page == 'child-development') ? 'active' : ''; ?>" href="child-development">Child Development</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'community-development-social-intervention') ? 'active' : ''; ?>" href="community-development-social-intervention">Community Development & Social Intervention</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'economic-services') ? 'active' : ''; ?>" href="economic-services">Economic Services</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'finance-accounting') ? 'active' : ''; ?>" href="finance-accounting">Finance & Accounting</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'gender-affairs') ? 'active' : ''; ?>" href="gender-affairs">Gender Affairs</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'general-services') ? 'active' : ''; ?>" href="general-services">General Services</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'human-resource-management') ? 'active' : ''; ?>" href="human-resource-management">Human Resource Management</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'nutrition') ? 'active' : ''; ?>" href="nutrition">Nutrition</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'planning-research-statistics') ? 'active' : ''; ?>" href="planning-research-statistics">Planning, Research & Statistics</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'procurement') ? 'active' : ''; ?>" href="procurement">Procurement</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'reform-coordination-service-improvement') ? 'active' : ''; ?>" href="reform-coordination-service-improvement">Reform Coordination & Service Improvement</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'special-duties') ? 'active' : ''; ?>" href="special-duties">Special Duties</a></li>
                            <li><a class="dropdown-item <?php echo ($current_page == 'women-development') ? 'active' : ''; ?>" href="women-development">Women Development</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
