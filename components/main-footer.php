        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="./departments/women-development" class="text-light text-decoration-none">Women Development</a></li>
                        <li class="mb-2"><a href="./departments/child-development" class="text-light text-decoration-none">Child Development</a></li>
                        <li class="mb-2"><a href="./departments/gender-affairs" class="text-light text-decoration-none">Gender Affairs</a></li>
                        <li class="mb-2"><a href="./departments/nutrition" class="text-light text-decoration-none">Nutrition</a></li>
                    </ul>
                </div>
