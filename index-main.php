<?php
// index.php - Main homepage for Federal Ministry of Women Affairs
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .dropdown-menu[aria-labelledby="departmentsDropdown"] {
        ...
        /* Dropdown item styles are already defined above */
        
        /* Nav link and dropdown toggle styles are already defined above */
        /* News section styles */
        ...
        /* Force logo to be exactly 100px with !important to override any other styles */
        .navbar-brand img,
        .header-logo,
        .logo-resized,
        img[alt*="Federal Ministry of Women Affairs Logo"],
        .navbar-brand > img,
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (scrollingText) {
            ...
            // Start animation after a short delay to ensure the browser has rendered the text
            setTimeout(() => {
...
<body>
        ...
        <div class="container">
            <div id="heroCarousel" class="carousel slide">
                <div class="carousel-inner" aria-live="polite">
                    ...
                    <div class="carousel-item">
                        <div class="image-container d-flex justify-content-center">
                            <img src="images/2025_07_11_16_39_IMG_2805.JPG" 
     alt="FMWA Event" 
     class="img-fluid me-2 carousel-image">
                            <img src="images/2025_07_11_16_40_IMG_2806.JPG" 
     alt="FMWA Event" 
    ...
    <!-- Footer will be inserted here by components/footer.js -->
    ...
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        // Navigation related scripts can be added here
    });
    </script>
