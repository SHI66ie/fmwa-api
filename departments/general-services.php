    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.85rem; line-height: 1.3; max-width: 650px; margin: 0 auto;">Providing essential administrative and support services to ensure smooth operations across all ministry functions.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h6 class="mb-1">Mrs. Nkechi Okorie</h6>
