<?php
// Page configuration
$page_title = "Procurement Department - Federal Ministry of Women Affairs";
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.85rem; line-height: 1.3; max-width: 650px; margin: 0 auto;">Managing procurement processes and ensuring transparent, efficient acquisition of goods and services for ministry operations.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p>Ensuring transparent, efficient, and cost-effective procurement of goods and services for ministry operations and programs.</p>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Managing competitive bidding and tender processes.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5>Vendor Relations</h5>
                                        <p class="text-muted">Supplier registration, evaluation, and relationship management.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Contract negotiation, execution, and performance monitoring.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Ensuring adherence to procurement laws and best practices.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="director-photo-container mb-3">
                            <img src="../images/directors/procurement-director.jpg" 
                                 alt="Mrs. Blessing Okoro - Director" 
                        ...
                        <h6 class="mb-1">Mrs. Blessing Okoro</h6>
                        <p class="text-muted small mb-3">Director, Procurement</p>
                        
                        <div class="contact-details text-start">
                            <p class="mb-2">
                                <i class="fas fa-phone text-primary me-2"></i>
                                <strong>Phone:</strong> +234-9-461-0009
                            </p>
                            <p class="mb-2">
                                <i class="fas fa-envelope text-primary me-2"></i>
                                <strong>Email:</strong> procurement@fmwa.gov.ng
                            </p>
                            <p class="mb-0">
