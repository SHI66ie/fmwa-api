    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.95rem; line-height: 1.4; max-width: 700px; margin: 0 auto;">Managing procurement processes and ensuring transparent, efficient acquisition of goods and services for ministry operations.</p>
            </div>
        </div>
    </div>
</section>
