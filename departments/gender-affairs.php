<?php
// Page configuration
$page_title = "Gender Affairs Department - Federal Ministry of Women Affairs";
$department_name = "Gender Affairs";
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.85rem; line-height: 1.3; max-width: 650px; margin: 0 auto;">Promoting gender equality and mainstreaming gender perspectives in policies, programs, and development initiatives.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p>Promoting gender equality and mainstreaming gender perspectives in policies, programs, and development initiatives.</p>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Integration of gender perspectives in policy development.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <i class="fas fa-fist-raised text-primary fa-2x"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h5>Anti-GBV Programs</h5>
                                        <p class="text-muted">Prevention and response to gender-based violence.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Collection and analysis of gender-disaggregated data.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5>Advocacy & Awareness</h5>
                                        <p class="text-muted">Public awareness campaigns on gender equality.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="director-photo-container mb-3">
                            <img src="../images/directors/gender-affairs-director.jpg" 
                                 alt="Dr. Hauwa Mohammed - Director" 
