<?php
// Page configuration
$page_title = "Finance & Accounting Department - Federal Ministry of Women Affairs";
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.85rem; line-height: 1.3; max-width: 650px; margin: 0 auto;">Managing financial resources and accounting operations to ensure transparency and fiscal responsibility.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p>Managing financial resources and ensuring transparent, accountable financial operations across all ministry programs.</p>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Strategic budget planning and allocation for ministry programs.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Real-time tracking of expenditures and financial performance.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Transparent procurement processes for ministry operations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Internal audit and regulatory compliance management.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="director-photo-container mb-3">
                            <img src="../images/directors/finance-accounting-director.jpg" 
                                 alt="Mrs. Adunni Ogundimu - Director" 
                        ...
                        <h6 class="mb-1">Mrs. Adunni Ogundimu</h6>
                        <p class="text-muted small mb-3">Director, Finance & Accounting</p>
                        
                        <div class="contact-details text-start">
                            <p class="mb-2">
                                <i class="fas fa-phone text-primary me-2"></i>
                                <strong>Phone:</strong> +234-9-461-0004
                            </p>
                            <p class="mb-2">
                                <i class="fas fa-envelope text-primary me-2"></i>
                                <strong>Email:</strong> finance@fmwa.gov.ng
                            </p>
                            <p class="mb-0">
