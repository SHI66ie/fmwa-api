    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.95rem; line-height: 1.4; max-width: 700px; margin: 0 auto;">Building stronger communities through social intervention programs and community-based development initiatives.</p>
            </div>
        </div>
    </div>
</section>
