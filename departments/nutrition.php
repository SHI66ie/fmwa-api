    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.85rem; line-height: 1.3; max-width: 650px; margin: 0 auto;">Promoting proper nutrition and food security for women, children, and vulnerable populations across Nigeria.</p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="director-photo-container mb-3">
                            <img src="../images/directors/nutrition-director.jpg" 
                                 alt="Dr. Kemi Adebayo - Director" 
