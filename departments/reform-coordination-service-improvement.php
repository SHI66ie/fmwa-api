    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <p class="mb-0" style="font-size: 0.85rem; line-height: 1.3; max-width: 650px; margin: 0 auto;">Leading organizational reforms and service improvement initiatives to enhance ministry effectiveness and public service delivery.</p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="director-photo-container mb-3">
                            <img src="../images/directors/reform-coordination-service-improvement-director.jpg" 
                                 alt="Dr. Musa Abdullahi - Director" 
                        ...
                        <h6 class="mb-1">Dr. Musa Abdullahi</h6>
                        <p class="text-muted small mb-3">Director, Reform Coordination & Service Improvement</p>
                        
                        <div class="contact-details text-start">
                            <p class="mb-2">
                                <i class="fas fa-phone text-primary me-2"></i>
                                <strong>Phone:</strong> +234-9-461-0010
                            </p>
                            <p class="mb-2">
                                <i class="fas fa-envelope text-primary me-2"></i>
                                <strong>Email:</strong> reform@fmwa.gov.ng
                            </p>
                            <p class="mb-0">
